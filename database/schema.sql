...
-- ============================================
-- Triggers (disabled during bulk load for performance)
-- ============================================
...
-- CREATE TRIGGER trg_update_room_activity
-- AFTER INSERT ON messages
...
-- Increase shared buffers (set in postgresql.conf)
-- shared_buffers = 4GB
...
-- Refresh materialized view (call periodically or after load test)
-- REFRESH MATERIALIZED VIEW CONCURRENTLY messages_per_minute;

-- Analyze tables for query planner
-- ANALYZE messages;
-- ANALYZE user_activity;
-- ANALYZE room_activity;